...
public static class Palette
{
    ...
    // Item pedido: "troque o tema de cor roxo para um tom azul igual
    // da logo" — matiz rotacionado de roxo (~247°) pra azul suave
    // (~210°, o mesmo tom do logo "PC" do app), mantendo luminosidade
    // e a relação de contraste com AccentHover que já existia.
    public static readonly Color Accent = Color.Parse("#66A1DD");
    public static readonly Color AccentHover = Color.Parse("#5590CC");
